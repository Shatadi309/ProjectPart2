...
{//start of namespace
    ...
    {//start of class
        ...
        {//start of submit_name method
            ...
            //Prompting user to re-enter their username
            if (string.IsNullOrWhiteSpace(name))
            {//start of if 
                MessageBox.Show(
                           "Please enter a username before continuing to chat.","Username Required",
                           MessageBoxButton.OK);
            ...
            {//start of if
                ...
                error_method("VANTA", "Hey " + name + "  welcome to AI cybersecurity", chats);
            ...
            {//start of else
                ...
                error_method("VANTA ", "Hey " + name + " welcome back, how can i help you today", chats);
